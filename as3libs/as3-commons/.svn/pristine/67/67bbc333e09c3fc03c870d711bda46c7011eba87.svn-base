...
package org.as3commons.async.operation.impl {
	...
	public class AbstractCancelableOperation extends AbstractOperation implements ICancelableOperation {
		
		public function AbstractCancelableOperation(timeoutInMilliseconds:int=0, autoStartTimeout:Boolean=true) {
