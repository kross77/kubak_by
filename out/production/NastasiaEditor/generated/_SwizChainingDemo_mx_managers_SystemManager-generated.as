...
[ExcludeClass]
public class _SwizChainingDemo_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _SwizChainingDemo_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "SwizChainingDemo" : String(params[0]);
...
,
            ...
            compiledResourceBundleNames: [ "collections", "components", "containers", "controls", "core", "effects", "layout", "skins", "sparkEffects", "styles" ],
            creationComplete: "creationCompleteHandler(event)",
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "SwizChainingDemo",
            mixins: [ "_SwizChainingDemo_FlexInit", "_SwizChainingDemo_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
            placeholderRsls: [
